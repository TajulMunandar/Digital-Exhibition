...
@section('content')
    ...
    <div class="row p-2">
        <div class="col">
            <button class="btn btn-primary float-end mb-3" data-bs-toggle="modal" data-bs-target="#tambahKategoriModal">
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('kategori.destroy', $kategori->id) }}" method="POST"
                                        ...
                                        <button class="btn btn-danger"
                                            onclick="return confirm('Yakin hapus kategori ini?')">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach
